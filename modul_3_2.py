...
пользователя(администрации или службы поддержки). Тем не менее должна быть возможность сменить его в
редких случаях.
...
def send_email(message, recipient, sender = 'university.help@gmail.com'): #Sender Recipient Message
